...
export default function Card({
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-4 max-w-sm border border-gray-200">
      ...
      <p className="text-gray-600 mt-2">Fan Size: {fanSize} mm</p>
      <p className="text-gray-600 mt-2">Fan Speed: {fanSpeed} RPM</p>
      <p className="text-gray-600 mt-2">Noise Level: {fanNoiseLevel} dBA</p>
      <p className="text-gray-600 mt-2">Number of Fans: {numberOfFans}</p>
